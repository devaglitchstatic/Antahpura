#!/usr/bin/env python3
"""
freeze_baseline.py — record the current verified state of the repository
as audit/BASELINE_V20.json.

The baseline captures:
  - The audit summary at freeze time
  - SHA-256 hashes of the canonical files
  - The 14-character roster with chub_card_ids

Re-run after any intentional change to a canonical file.
"""
...
def main():
    ...
    baseline = {
        ...
        "description": (
            ...
            "The hashes below are the signatures of the canonical files "
            "as verified by the audit and smoke test. Any change to a "
            "hashed file invalidates the baseline and should be accompanied "
            "by a new freeze."
        ),
        "audit_summary": {
