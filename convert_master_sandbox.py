...
# 🔄 FIXED: Outputting first inside Termux's local safe app storage box container path
with open("Antahpura.json", "w", encoding="utf-8") as f:
    json.dump(chub_lorebook, f, indent=2, ensure_ascii=False)

print("\n✅ SUCCESS: Formatted tree successfully wrapped into sandboxed JSON structure!")
